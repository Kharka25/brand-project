    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='text-3xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat ipsum voluptas numquam minima, velit unde saepe. Beatae asperiores tenetur nostrum.</p>
            </div>
            ...
            <div className='grid md:grid-cols-2'>
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <p className='text-2xl py-8 text-slate-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum, praesentium.</p>
